...
var KTCardsWidget1 = function () {
    ...
    var initChart = function() {
        ...
        var labelColor = KTUtil.getCssVariableValue('--wncms-gray-500');         
        var baseColor = KTUtil.isHexColor(color) ? color : KTUtil.getCssVariableValue('--wncms-' + color);
        var secondaryColor = KTUtil.getCssVariableValue('--wncms-gray-300');        
...
var KTCardsWidget10 = function () {
    ...
    var initChart = function() {
        ...
        drawCircle(KTUtil.getCssVariableValue('--wncms-primary'), options.lineWidth, 100 / 150);
        drawCircle(KTUtil.getCssVariableValue('--wncms-success'), options.lineWidth, 100 / 250);   
    }
...
var KTCardWidget12 = function () {
    ...
    var initChart = function(chart) {
        ...
        var height = parseInt(KTUtil.css(element, 'height'));       
        var borderColor = KTUtil.getCssVariableValue('--wncms-border-dashed-color');
        var baseColor = KTUtil.getCssVariableValue('--wncms-gray-800');
        var lightColor = KTUtil.getCssVariableValue('--wncms-success');
...
var KTCardsWidget4 = function () {
    ...
    var initChart = function() {
        ...
        // Init 
        drawCircle('#E4E6EF', options.lineWidth, 100 / 100); 
        drawCircle(KTUtil.getCssVariableValue('--wncms-danger'), options.lineWidth, 100 / 150);
        drawCircle(KTUtil.getCssVariableValue('--wncms-primary'), options.lineWidth, 100 / 250);   
    }
...
var KTCardsWidget6 = function () {
    ...
    var initChart = function() {
        ...
        var labelColor = KTUtil.getCssVariableValue('--wncms-gray-500');
        var borderColor = KTUtil.getCssVariableValue('--wncms-border-dashed-color');
        var baseColor = KTUtil.getCssVariableValue('--wncms-primary');
        var secondaryColor = KTUtil.getCssVariableValue('--wncms-gray-300');
...
var KTChartsWidget1 = function () {
    ...
    var initChart = function() {
        ...
        var negativeColor = element.hasAttribute('data-kt-negative-color') ? element.getAttribute('data-kt-negative-color') : KTUtil.getCssVariableValue('--wncms-success');
...
var KTChartsWidget10 = function () {
    ...
    var initChart = function(chart, toggle, chartSelector, data, initByDefault) {
        ...
        var height = parseInt(KTUtil.css(element, 'height'));
        var labelColor = KTUtil.getCssVariableValue('--wncms-gray-900');
        var borderColor = KTUtil.getCssVariableValue('--wncms-border-dashed-color');    
        ...
        var options = {
            ...
            xaxis: {
                ...
                labels: {
                    style: {
                        colors: KTUtil.getCssVariableValue('--wncms-gray-500'),
                        fontSize: '13px'
                    }                    
                },
                crosshairs: {
            ...
            colors: [KTUtil.getCssVariableValue('--wncms-primary'), KTUtil.getCssVariableValue('--wncms-primary-light')],
            grid: {
                borderColor: borderColor,
                strokeDashArray: 4,
                yaxis: {
...
var KTChartsWidget11 = function () {
    ...
    var initChart = function(chart, toggle, chartSelector, data, initByDefault) {
        ...
        var labelColor = KTUtil.getCssVariableValue('--wncms-gray-500');
        var borderColor = KTUtil.getCssVariableValue('--wncms-border-dashed-color');
        var baseColor = KTUtil.getCssVariableValue('--wncms-success');         
    ...
    var initChart = function () {
        ...
        var init = function() {
            ...
            xAxis.get("renderer").labels.template.setAll({
                fontWeight: "400",
                fontSize: 13,
                fill: am5.color(KTUtil.getCssVariableValue('--wncms-gray-500'))
            });
            ...
            yAxis.get("renderer").grid.template.setAll({
                stroke: am5.color(KTUtil.getCssVariableValue('--wncms-gray-300')),
                strokeWidth: 1,
                strokeOpacity: 1,
                strokeDasharray: [3]
            });
            ...
            createSeries("Cars", "cars", KTUtil.getCssVariableValue('--wncms-primary'));
            createSeries("Motorcycles", "motorcycles", KTUtil.getCssVariableValue('--wncms-success'));
            createSeries("Bicycles", "bicycles", KTUtil.getCssVariableValue('--wncms-warning'));
            ...
            rangeDataItem.get("grid").setAll({
                stroke: am5.color(KTUtil.getCssVariableValue('--wncms-gray-200')),
                strokeOpacity: 0.5,
                strokeDasharray: [3],
            });

            rangeDataItem.get("axisFill").setAll({
                fill: am5.color(KTUtil.getCssVariableValue('--wncms-gray-200')),
                fillOpacity: 0.1,
            });
            ...
            rangeDataItem2.get("grid").setAll({
                stroke: am5.color(KTUtil.getCssVariableValue('--wncms-danger')),
                strokeOpacity: 1,
                strokeDasharray: [3],
            });
            ...
            var data = [
                {
                    ...
                    columnSettings: {
                        fillOpacity: 1,
                        fill: am5.color(KTUtil.getCssVariableValue('--wncms-info')),
                    },
                },
                {
                    category: "Marketing",
                    ...
                    columnSettings: {
                        fillOpacity: 1,
                        fill: am5.color(KTUtil.getCssVariableValue('--wncms-danger')),
                    },
                },
                {
                    ...
                    columnSettings: {
                        fillOpacity: 1,
                        fill: am5.color(KTUtil.getCssVariableValue('--wncms-primary')),
                    },
                },
                {
                    ...
                    columnSettings: {
                        fillOpacity: 1,
                        fill: am5.color(KTUtil.getCssVariableValue('--wncms-success')),
                    },
                },
            ];
        ...
        var init = function() {
            ...
            var paretoSeries = chart.series.push(
                am5xy.LineSeries.new(root, {
                    ...
                    valueYField: "pareto",
                    categoryXField: "country",
                    stroke: am5.color(KTUtil.getCssVariableValue('--wncms-dark')),
                    maskBullets: false,
                })
            );
...
var KTChartsWidget17 = (function () {
    ...
    var initChart = function () {
        ...
        var init = function() {
            ...
            series.data.setAll([
                { value: 10, category: "One", fill: am5.color(KTUtil.getCssVariableValue('--wncms-primary')) },
                { value: 9, category: "Two", fill: am5.color(KTUtil.getCssVariableValue('--wncms-success')) },
                { value: 6, category: "Three", fill: am5.color(KTUtil.getCssVariableValue('--wncms-danger')) },
                { value: 5, category: "Four", fill: am5.color(KTUtil.getCssVariableValue('--wncms-warning')) },
                { value: 4, category: "Five", fill: am5.color(KTUtil.getCssVariableValue('--wncms-info')) },
                { value: 3, category: "Six", fill: am5.color(KTUtil.getCssVariableValue('--wncms-secondary')) }
            ]);
...
var KTChartsWidget2 = function () {
    ...
    var initChart = function() {
        ...
        var color = element.getAttribute('data-kt-chart-color');
        var height = parseInt(KTUtil.css(element, 'height'));
        var labelColor = KTUtil.getCssVariableValue('--wncms-gray-800');
        var strokeColor = KTUtil.getCssVariableValue('--wncms-border-dashed-color');
        var baseColor = KTUtil.getCssVariableValue('--wncms-' + color);
        var lightColor = KTUtil.getCssVariableValue('--wncms-' + color + '-light');
...
var KTChartsWidget20 = function () {
    ...
    var initChart = function(chart) {
        ...
        var labelColor = KTUtil.getCssVariableValue('--wncms-gray-500');
        var borderColor = KTUtil.getCssVariableValue('--wncms-border-dashed-color');
        var baseColor = KTUtil.getCssVariableValue('--wncms-danger');
        var lightColor = KTUtil.getCssVariableValue('--wncms-danger');
...
var KTChartsWidget22 = function () {
    ...
    var initChart = function(tabSelector, chartSelector, data, initByDefault) {
        ...
        var options = {
            ...
            colors: [
                KTUtil.getCssVariableValue('--wncms-info'), 
                KTUtil.getCssVariableValue('--wncms-success'), 
                KTUtil.getCssVariableValue('--wncms-primary'), 
                KTUtil.getCssVariableValue('--wncms-danger') 
            ],           
            stroke: {
              width: 0
            },
		...
		var init = function() {
			...
			var series2 = chart.series.push(
				am5xy.LineSeries.new(root, {
					...
					categoryXField: "year",
					fill: am5.color(KTUtil.getCssVariableValue("--wncms-success")),
					stroke: am5.color(KTUtil.getCssVariableValue("--wncms-success")),
					tooltip: am5.Tooltip.new(root, {
						pointerOrientation: "horizontal",
						labelText: "{name} in {categoryX}: {valueY} {info}",
					}),
			...
			series2.bullets.push(function () {
				return am5.Bullet.new(root, {
					sprite: am5.Circle.new(root, {
						...
						stroke: am5.color(KTUtil.getCssVariableValue("--wncms-success")),
						radius: 5,
						fill: am5.color(KTUtil.getCssVariableValue("--wncms-success-light")),
					}),
				});
			});
			...
			legend.labels.template.setAll({
				fontWeight: "600",
				fontSize: 14,
				fill: am5.color(KTUtil.getCssVariableValue("--wncms-gray-700")),
			});
	...
	var initChart = function () {
		...
		var init = function() {
			...
			var title = map.children.push(am5.Label.new(root, {
				...
				fontSize: 14,
				fontWeight: '500',
				fill: am5.color(KTUtil.getCssVariableValue('--wncms-gray-800')),
				y: 20,
				x: am5.p50,
				centerX: am5.p50
			}));
			...
			var polygonSeries = map.series.push(
				am5map.MapPolygonSeries.new(root, {
					fill: am5.color(KTUtil.getCssVariableValue('--wncms-gray-300')),
	...
	var initChart1 = function () {
		...
		var init = function() {
			...
			xRenderer.grid.template.setAll({
				location: 0.5,
				strokeDasharray: [2, 2],
				stroke: KTUtil.getCssVariableValue('--wncms-gray-400')
			});
...
var KTChartsWidget26 = function () {
    ...
    var initChart = function() {
        ...
        var borderColor = KTUtil.getCssVariableValue('--wncms-border-dashed-color');
        var baseColor = KTUtil.getCssVariableValue('--wncms-primary');
        var lightColor = KTUtil.getCssVariableValue('--wncms-primary');
        var chartInfo = element.getAttribute('data-kt-chart-info');
...
var KTChartsWidget28 = function () {
    ...
    var initChart = function(chart) {
        ...
        var labelColor = KTUtil.getCssVariableValue('--wncms-gray-500');
        var borderColor = KTUtil.getCssVariableValue('--wncms-border-dashed-color');
        var baseColor = KTUtil.getCssVariableValue('--wncms-info');         
...
var KTChartsWidget29 = function () {
    ...
    var initChart = function(chart) {
        ...
        var labelColor = KTUtil.getCssVariableValue('--wncms-gray-500');
        var borderColor = KTUtil.getCssVariableValue('--wncms-border-dashed-color');
        var baseColor = KTUtil.getCssVariableValue('--wncms-warning');         
...
var KTChartsWidget36 = function () {
    ...
    var initChart = function(chart) {
        ...
        var labelColor = KTUtil.getCssVariableValue('--wncms-gray-500');
        var borderColor = KTUtil.getCssVariableValue('--wncms-border-dashed-color');
        var baseprimaryColor = KTUtil.getCssVariableValue('--wncms-primary');
        var lightprimaryColor = KTUtil.getCssVariableValue('--wncms-primary');
        var basesuccessColor = KTUtil.getCssVariableValue('--wncms-success');
        var lightsuccessColor = KTUtil.getCssVariableValue('--wncms-success');
...
var KTChartsWidget39 = (function () {
	...
	var initChart = function () {
		...
		var init = function() {
			...
			xRenderer.grid.template.setAll({
				stroke: am5.color(KTUtil.getCssVariableValue("--wncms-gray-700"))
			});
        ...
        var options = {
            ...
            xaxis: {
                ...
                labels: {
                    ...
                    style: {
                        colors: KTUtil.getCssVariableValue('--wncms-gray-400'),
                        fontSize: '14px',
                        fontWeight: '600',
                        align: 'left'                                              
                    }                  
            ...
            yaxis: {
                labels: {                   
                    style: {
                        colors: KTUtil.getCssVariableValue('--wncms-gray-800'),
                        fontSize: '14px',
                        fontWeight: '600'                                                                 
                    },
                    offsetY: 2,
    ...
    var initChart = function(chartSelector) {
        ...
        var options = {
            ...
            xaxis: {
                ...
                labels: {
                    style: {
                        colors: KTUtil.getCssVariableValue('--wncms-gray-700'),
                        fontSize: '12px'
                    }
                }
            },
    ...
    var initChart = function(chart, toggle, selector, data, initByDefault) {
        ...
        var options = {
            ...
            crosshairs: {
                ...
                position: 'front',
                stroke: {
                    color: KTUtil.getCssVariableValue('--wncms-border-dashed-color'),
                    width: 1,
                    dashArray: 0,
                }
            },           
            colors: [
                KTUtil.getCssVariableValue('--wncms-primary'),
                KTUtil.getCssVariableValue('--wncms-success'),   
                KTUtil.getCssVariableValue('--wncms-warning'),
                KTUtil.getCssVariableValue('--wncms-danger'),
                KTUtil.getCssVariableValue('--wncms-info'),
                '#43CED7'
            ],
...
var KTChartsWidget9 = function () {
    ...
    var initChart = function() {
        ...
        var height = parseInt(KTUtil.css(element, 'height'));
        var labelColor = KTUtil.getCssVariableValue('--wncms-gray-400');
        var borderColor = KTUtil.getCssVariableValue('--wncms-border-dashed-color');    

        var baseColor = KTUtil.getCssVariableValue('--wncms-gray-200');
        var secondaryColor = KTUtil.getCssVariableValue('--wncms-primary');
        ...
        var options = {
            ...
            markers: {
                colors: [baseColor, secondaryColor],
                strokeColor: [KTUtil.getCssVariableValue('--wncms-primary'), KTUtil.getCssVariableValue('--wncms-gray-300')],
                strokeWidth: 3
            }
        };        
    ...
    var initMap = function () {
        ...
        var init = function() {
            ...
            polygonSeriesHighlighted.mapPolygons.template.set(
                "fill",
				am5.color(KTUtil.getCssVariableValue('--wncms-primary')),
            );
...
var KTSlidersWidget1 = function() {
    ...
    var initChart = function(chart, query, data) {
        ...
        var height = parseInt(KTUtil.css(element, 'height'));
        var baseColor = KTUtil.getCssVariableValue('--wncms-' + 'primary');
        var lightColor = KTUtil.getCssVariableValue('--wncms-' + 'primary-light' );         
...
var KTSlidersWidget7 = function() {
    ...
    var initChart = function(chart, query, data) {
        ...
        var height = parseInt(KTUtil.css(element, 'height'));
        var baseColor = KTUtil.getCssVariableValue('--wncms-' + 'danger');
        var lightColor = KTUtil.getCssVariableValue('--wncms-' + 'white' );         
...
var KTTablesWidget14 = function () {
    ...
    var initChart = function(chart, chartSelector, data, initByDefault) {
        ...
        var strokeColor = KTUtil.getCssVariableValue('--wncms-' + 'gray-300');
        var baseColor = KTUtil.getCssVariableValue('--wncms-' + color);
        var lightColor = KTUtil.getCssVariableValue('--wncms-body-bg');
