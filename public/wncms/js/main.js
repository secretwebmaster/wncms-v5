...
if (document.querySelector('#template-filters')) {
    let filterTemplates = (search, category) => {
        ...
        let showCategoryLabel = (name) => {
            var element = document.querySelector('[data-category-label="' + name + '"]');
            if(element){
                element.classList.remove('d-none');
            }
        }
...
if (document.querySelector('#form-chat')) {
    ...
    let scrollChatWindowToEnd = () => {
        ...
        console.log(document.querySelector('#chat-messages').scrollTop);
        console.log(document.querySelector('#chat-messages').scrollHeight)
        document.querySelector('#chat-messages').scrollTop = document.querySelector('#chat-messages').scrollHeight;
    }
    /**
     * update old message time
     */
    let updateOldMessageTime = (time_arr) => {
        console.log('update old message time');
        //get message ids

        //rended ids->value to each old message
    }
